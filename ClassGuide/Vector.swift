...
class Renaissance: Requirement {
    ...
    func printProgress() -> [(String, Float)] {
        ...
        progress.append(("4(Fxxx) (Core) (M)", Float(FxxxCourses) / Float(FxxxRequirement)))
        progress.append(("Fyxx & Fzxx | y != z (Core) (M)", Float(hundredthsIs2or8) / Float(differentHundredthsRequirement)))
        progress.append(("Fyxx | y == 2 or 8 (Core) (M)", hundredthsIs2or8 ? 1 : 0))
        return progress
    }
}
...
class AI: Requirement {
    ...
    func printProgress() -> [(String, Float)] {
        var progress: [(String, Float)] = []
        progress.append(("CS4700 (Core) (M)", takenCS4700 ? 1 : 0))
        progress.append(("CS4701 (Core) (M)", takenCS4701 ? 1 : 0))
        progress.append(("F78x/F75x (Core) (M)", takenF78xOrF75x ? 1 : 0))
...
class Graphics: Requirement {
    ...
    func printProgress() -> [(String, Float)] {
        var progress: [(String, Float)] = []
        progress.append(("CS4620 (Core) (M)", taken4620 ? 1 : 0))
        progress.append(("CS621 (Core) (M)", taken4621 ? 1 : 0))
        progress.append(("CSF2xx (Core) (M)", takenF2xx ? 1 : 0))
        progress.append(("CS5625/CS5643/CS6620/CS6630/CS6640/CS6650 (Core) (M)", taken5625or5643or6620or6630or6640or6650 ? 1 : 0))
        progress.append(("CS56xx/CS3152/CS4152/CS5154 (Core) (M)", takenF6xxor3152or4152or4154 ? 1 : 0))
        return progress
    }
}
...
class PL: Requirement {
    ...
    func printProgress() -> [(String, Float)] {
        var progress: [(String, Float)] = []
        progress.append(("CSF110 (Core) (M)", takenF110 ? 1 : 0))
        progress.append(("CS4120 (Core) (M)", taken4120 ? 1 : 0))
        progress.append(("CS4121 (Core) (M)", taken4121 ? 1 : 0))
        progress.append(("CS4860/CS5114/CS5860/CSF810/CS6110 (Core) (M)", taken4860or5114or5860orF810or6110 ? 1 : 0))
        progress.append(("CS202x (Core) (M)", taken202x ? 1 : 0))
        return progress
    }
}
...
class SE: Requirement {
    ...
    func printProgress() -> [(String, Float)] {
        var progress: [(String, Float)] = []
        progress.append(("CS5150/CS5152 (Core) (M)", taken5150or5152 ? 1 : 0))
        progress.append(("2(Practicums) (Core) (M)", Float(practicumsFulfilled) / Float(requiredPracticums)))
        progress.append(("CS4152/CS4154/CSF45x/CS5300/CS5412/CS5414/CS5625/CS5643/CS6620/CS6630/CS6650 (Core) (M)",
            taken4152or4154orF45xor5300or5412or5414or5625or5643or6620or6630or6650 ? 1 : 0))
        return progress
    }
}
...
class SD: Requirement {
    ...
    func printProgress() -> [(String, Float)] {
        var progress: [(String, Float)] = []
        progress.append(("CS4411/CS4321 (Core) (M)", (taken4411 || taken4321) ? 1 : 0))
        progress.append(("3(CSF4xx/CSF12x/CSF32x/CS5300) (Core) (M)", Float(F4xxorF12xorF32xor5300Fulfilled) / Float(requiredF4xxorF12xorF32xor5300)))
